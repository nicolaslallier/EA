...
Date : 2026-09-13
Statut : Accepté
Supersédé en partie par : [`0029`](0029-nouvelle-adresse-du-cluster-et-postgresql-sur-le-mac.md) — le port du PostgreSQL jetable (5433) et son garde, qui refuse aussi le port partagé.
